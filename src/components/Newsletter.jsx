...
function Newsletter() {
    return (
        <section className="newsletter row p-5 justify-content-center">
                ...
                <div className="col-12 col-lg-7 col-md-7 mt-5 input_row">
                    ...
                    <div className="input-group mb-3">
                        <input type="text" className="form-control" placeholder="Enter your email here" aria-label="Enter your email here" aria-describedby="buttons"/>
